  ...
  return (
    <div className={clsx("add-todo", { active: inputValue })}>
      ...
      <div className="add-todo-input">
        <input id="add-todo-input" type="text" placeholder="新增工作" value={inputValue} onChange={handleChange} />
      </div>
      <div className="add-todo-action">
        <button className="btn-reset btn-add" onClick={() => handleClick('add')}> 新增 </button>
      </div>
    </div>
  )
}
